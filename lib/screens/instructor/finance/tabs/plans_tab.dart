            ...
            child: ListView(
              ...
              children: [
                _buildPlanCard(
                  ...
                  description: 'Ideal para empezar sin costos fijos.',
                  features: {
                    'Publicación ilimitada': true,
                    'Gestión de agenda': true,
                    'Perfil público': true,
                  ...
                  isCurrent: widget.currentPlan == 'Comisión',
                  color: Colors.blueAccent,
                  onSelect: () => _confirmPlanChange('Comisión'),
                ),
                _buildPlanCard(
                  context,
                  title: 'Básico',
                  ...
                  description: 'Reduce la comisión y accede a más herramientas.',
                  features: {
                    'Publicación ilimitada': true,
                    'Gestión de agenda': true,
                    'Perfil público': true,
                  ...
                  isCurrent: widget.currentPlan == 'Básico',
                  color: AppColors.neonPurple,
                  onSelect: () => _confirmPlanChange('Básico'),
                ),
                _buildPlanCard(
                  context,
                  title: 'Pro',
                  ...
                  description: 'Comisión mínima y herramientas de IA.',
                  features: {
                    'Publicación ilimitada': true,
                    'Gestión de agenda': true,
                    'Perfil público': true,
